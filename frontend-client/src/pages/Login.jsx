...
Lucide-react (bộ icon giống HeroIcons)
Tailwind CSS (style qua class name)
JSX (cú pháp HTML trong JS)
*/
...
/*
name = tên của input (email, password, rememberMe)
Nếu input là checkbox → dùng checked
Nếu input là text/email/password → dùng value
*/ 
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="btn-secondary flex items-center justify-center gap-2 py-2">
